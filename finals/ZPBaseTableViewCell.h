...
@protocol ZPBaseTableViewCellDelegate;


@interface ZPBaseTableViewCell : UITableViewCell {
 ...
 */
@protocol ZPBaseTableViewCellDelegate <NSObject>
@optional
 ...
 */
- (void)cell:(ZPBaseTableViewCell *)cellView didTapUserButton:(PFUser *)aUser;
